	...
	node := v1.Node{
		ObjectMeta: metav1.ObjectMeta{
			...
			Annotations: map[string]string{
				"youthink.dev/yck-preemptible-killer-state": "2017-11-11T11:11:11Z",
			},
		},
	}
...
func TestGetDesiredNodeState_BetweenTwelveAndTwentyFour(t *testing.T) {
	...
	client.EXPECT().SetNodeAnnotation(gomock.Any(), "node-1", "youthink.dev/yck-preemptible-killer-state", gomock.Any()).AnyTimes()
